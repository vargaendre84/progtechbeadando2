public class KoltsegStrategia_PMAP extends KoltsegStrategia
{
    ...
    public KoltsegStrategia_PMAP(int nevErtek, int lejaratiIdo, int futamIdo,  double kamat, boolean tbsz)
    {
