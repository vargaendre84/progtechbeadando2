public class KoltsegStrategia_EMAP extends KoltsegStrategia
{
    ...
    public KoltsegStrategia_EMAP(int nevErtek, int lejaratiIdo, int futamIdo, double kamat, boolean tbsz)
    {
